...
IF %_build%==1532 set update.exe=0x01 &set update-status-action.exe=0x02 &exit /b
IF %_build%==1534 set update.exe=0x01 &set update-status-action.exe=0x02 &exit /b
IF %_build%==1536 set update.exe=0x01 &set update-status-action.exe=0x02 &exit /b
IF %_build%==1538 set update.exe=0x01 &set update-status-action.exe=0x02 &exit /b
